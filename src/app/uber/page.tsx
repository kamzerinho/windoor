            ...
            <div className="flex justify-end">
						...
						<div className="text-black text-lg md:text-2xl flex flex-col justify-center max-sm:px-5">
							<div className="flex flex-row gap-2 items-center py-2">
								<Image src="/mail-open-minus-svgrepo-com.svg" width="100" height="100" alt="mail" className="w-10 h-10" />
								<p className="">sales@windoorvision.eu</p>
							</div>
              <div className="flex flex-row gap-2 items-center py-2"><Image src="/phone-call-svgrepo-com.svg" width="100" height="100" alt="phone" className="w-10 h-10" /><p className="">+48 502 024 998</p></div>
              <div className="flex flex-row gap-2 items-center py-2"><Image src="/address-location-map-svgrepo-com.svg" width="100" height="100" alt="pin" className="w-10 h-10" /><p className="">Białystok, Polen</p></div>
						</div>
					</div>
				</div>
			</section>
